...
def wait_for_messages_with_subjects(smtp_test, expected_subjects_substrings, num_sec):
    ...
    def _check_subjects():
        ...
        not_found_subj_subs = expected_subjects_substrings - found_subjects_substrings
        if not_found_subj_subs:
            return False
    ...
    wait_for(_check_subjects, num_sec=num_sec, delay=3,
             message='Find expected subjects substrings in the received emails subjects.')
